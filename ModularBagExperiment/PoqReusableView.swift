...
public protocol PoqReusableView: class {
...
extension PoqReusableView {
    ...
    public static var poqNib: UINib? {
        let nibFileName: String = String(describing: self)
...
extension UITableView {
     ...
     */
    public func dequeueContentNotFoundCell() -> UICollectionViewCell {
...
extension UICollectionView {
     ...
     */
    @nonobjc
    public func dequeueContentNotFoundCell(forIndexPath indexPath: IndexPath) -> UICollectionViewCell {
